...
(function(){
  ...
  window.nav=function(id){
    ...
    if(id==='profile')   { setTimeout(() => { if(typeof checkUserBusiness==='function' && currentUser) checkUserBusiness(); loadMyProfilePosts(); loadProfileSocialData(); if(typeof initSocial==='function') initSocial(); }, 200); }
    if(id==='myFriends')  { setTimeout(() => { if(typeof initSocial==='function') initSocial(); }, 100); }
